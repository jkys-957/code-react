    ...
    <div className="p-4 m-2 mt-10 border-2 border-sky-200">
      ...
      <div className="flex justify-center">
        <div className="relative flex flex-wrap items-stretch w-full mb-4">
          ...
          <input className="w-4/5 p-6 border border-solid rounded-r shadow-md border-neutral-300"
      ...
      <div className="flex justify-center">
        <div className="relative flex flex-wrap items-stretch w-full mb-4">
          ...
          <select name="status" className="p-2 m-1 border-2 border-solid rounded"
      ...
      <div className="flex justify-end p-4">
        <button type="button" className="inline-block w-32 p-4 m-2 text-xl text-white bg-red-500 rounded"
                onClick={handleClickDelete}>Delete</button>
        <button type="button" className="w-32 p-4 m-2 text-xl text-white bg-blue-500 rounded"
